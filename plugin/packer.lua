...
return packer.startup(function(use)
	...
	-- ORDER MATTERS HERE (If lazy loaded take this into consideration)
	-- Language provider installer
	use({ "williamboman/mason.nvim" })
	use({ "williamboman/mason-lspconfig.nvim" })
	-- Non LSP linting
	use({ "jose-elias-alvarez/null-ls.nvim", rquires = "nvim-lua/plenary.nvim" })
